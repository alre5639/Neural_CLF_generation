...
For verifying 
'''
state_list = x, y, v, phi, theta = sympy.symbols('x y')
...
#define the flows:
flows = {
    x: v*math.cos(phi), #this is going to be a problem since z3 cant solve cos(), I think we can just make a piecewise function
    y: v*math.sin(phi), #same comment as above,
    v: u2,
    phi: v*tanh(u1)/L,
    theta: 1
}
